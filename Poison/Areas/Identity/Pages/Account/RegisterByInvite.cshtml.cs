...
namespace Poison.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Add the user tot he designated project
                    await _projectService.AddUserToProjectAsync(userId, Input.ProjectId);

                    //Add user to default role
                    await _userManager.AddToRoleAsync(user, nameof(PoisonRoles.Submitter));
