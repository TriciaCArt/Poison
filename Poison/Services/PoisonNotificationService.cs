...
{
    public class PoisonNotificationService : IPoisonNotificationService
    {
        private readonly ApplicationDbContext _context;
        private readonly IEmailSender _emailSender;
        private readonly IPoisonRolesService _rolesService;

        public PoisonNotificationService(ApplicationDbContext context,
                                     IEmailSender emailSender,
                                     IPoisonRolesService rolesService)
        {
            _context = context;
