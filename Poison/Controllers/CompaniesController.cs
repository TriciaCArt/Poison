...
namespace Poison.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(ApplicationDbContext context, UserManager<BTUser> userManager, IPoisonCompanyInfoService companyInfoService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            Company myCompany = await _companyInfoService.GetCompanyInfoById(companyId);
